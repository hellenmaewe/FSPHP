...
if(strpos(url(), "localhost:8080")){
    ...
    * JS
    */
    $mimJS = new MatthiasMullie\Minify\JS();
    $mimJS->add(__DIR__ . "/../../shared/scripts/jquery.min.js");
    $mimJS->add(__DIR__ . "/../../shared/scripts/jquery.form.js");
    $mimJS->add(__DIR__ . "/../../shared/scripts/jquery-ui.js");
    ...
    //Minify JS
    $mimJS->minify(__DIR__ . "/../../themes/".CONF_VIEW_THEME."/assets/scripts.js");
}
